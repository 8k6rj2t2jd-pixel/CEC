...
async function uploadFile(localFilePath, folder, mimeType) {
...
const uploadPartFile = (localFilePath, partId, fileId, mimeType) => uploadFile(localFilePath, `pecas/${partId}/ficheiros/${fileId}`, mimeType);
